...
public class Rogue extends PlayerClass {
    ...
    public Rogue(int damagePerLevel, int rangePerLevel, int defencePerLevel, int attackSpeedPerLevel, boolean premium, Item profileItem, int beginHealth, Item mainItem, List<Item> items, List<String> abilitys) {
