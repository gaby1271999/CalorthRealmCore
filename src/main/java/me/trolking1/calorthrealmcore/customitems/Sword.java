 ...
 */
@SerializableAs("sword")
public class Sword extends CustomItem implements ConfigurationSerializable {

    private int attackDamage, attackSpeed;

    public Sword(int attackDamage, int attackSpeed, int id, short damage, List<ItemFlag> itemFlags, String name, List<String> lore, List<String> enchants) {
    ...
    public Sword(Map<String, Object> map) {
        super(map);
